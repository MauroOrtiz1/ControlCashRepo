...
namespace ControlCash.Controllers
{
    ...
    public class ExportacionController : ControllerBase
    {
        ...
        public ExportacionController(ControlCashDbContext context)
        {
            _context = context;
        }

        // POST api/exportacion/generar-pdf
        [HttpPost("generar-pdf")]
        public async Task<IActionResult> GenerarPdfReporte([FromBody] ExportacionRequest request)
        {
            try
            {
        ...
        private void DibujarEncabezado(XGraphics gfx, XFont titleFont, XFont headerFont, XFont regularFont, 
            ExportacionRequest request, double leftMargin, double rightMargin, ref double currentY)
        {
            var mesNombre = CultureInfo.CurrentCulture.DateTimeFormat.GetMonthName(request.Mes);
            var titulo = $"REPORTE DE GASTOS - {mesNombre.ToUpper()} {request.Anio}";
        ...
        private void DibujarResumenCategorias(XGraphics gfx, XFont subHeaderFont, XFont regularFont, 
            List<ResumenCategoria> gastosPorCategoria, double leftMargin, double pageWidth, ref double currentY)
        {
        ...
        private void DibujarGraficoBarras(XGraphics gfx, List<ResumenCategoria> gastosPorCategoria, 
        ...
        private void DibujarDetalleGastos(XGraphics gfx, XFont subHeaderFont, XFont regularFont, XFont smallFont,
